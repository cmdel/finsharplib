module SobolDirectionData

// Helper data for the Sobol Quasi-Random Number generator in module QuasiRandom
// Search for "sobol_sequence" for documentation details.
// Credit to Frances Kuo for these direction numbers: http://web.maths.unsw.edu.au/~fkuo/sobol/
let direction_data =  [|
                    (1,0,0,[|1|]);
                    (2,1,0,[|1;|])
                    (3,2,1,[|1;3;|])
